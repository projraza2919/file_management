  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Select file to be updated</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            ...
            <div class="info-box '.$bg.'">
              ...
              <div class="info-box-content">
                ...
                <span class="progress-description">
                  '.date("d-m-Y H:i:s",strtotime($fetch['added_on'])).'
                </span><br><span>Description: '.$fetch['description'].'</span>
                <button onclick="file_details(this.id)" id="'.$fetch['id'].'" class="btn btn-success">View</button>
                <button onclick="file_update(this.id)" id="'.$fetch['id'].'" class="btn btn-success">Update</button>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
